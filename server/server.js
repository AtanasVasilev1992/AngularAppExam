(function (global, factory) {
    ...
    function createHandler(plugins, services) {
        return async function handler(req, res) {
            ...
            let status = 200;
            let headers = {
                'Access-Control-Allow-Origin': 'http://localhost:4200', // Позволява заявки само от Angular приложението
                'Access-Control-Allow-Credentials': 'true',            // Разрешава изпращането на cookies
            ...
            if (method == 'OPTIONS') {
                Object.assign(headers, {
                    ...
                    'Access-Control-Allow-Credentials': 'true',           // Разрешаваме cookies
    ...
    var seedData = {
    	museums: {
            ...
            owner: {
                _id: "user2",
                username: "ethno_admin",
                email: "admin@ethnomuseum.bg"
            },
    ...
    places: {
        "6a7b8c9d-0e1f-2g3h-4i5j-k6l7m8n9o0p1": {
        name: "Sea Garden",
        city: "Varna",
        image: "https://visit.varna.bg/media/cache/3f/03/thumb7_Morska_gradina_1.jpg",
        description: "The Sea Garden is a large park in Varna, offering breathtaking views of the Black Sea, beautiful green spaces, and a variety of attractions including museums, a zoo, and an amphitheater.",
        workTime: "Open 24/7",
        owner: {
            _id: "user6",
            username: "seagarden_admin",
            email: "admin@seagarden.bg"
        },
        createdAt: "2024-01-06T14:00:00Z",
        updatedAt: "2024-01-06T14:00:00Z",
        __v: 0
    },
    "7b8c9d0e-1f2g-3h4i-5j6k-l7m8n9o0p2q3":{
        name: "Seven Rila Lakes",
        city: "Sapareva Banya",
        image: "https://freesofiatour.com/wp-content/uploads/2018/05/seven-rila-lakes-how-to-get-to.jpeg",
        description: "The Seven Rila Lakes are a group of glacial lakes located in the Rila Mountain. They are one of Bulgaria's most iconic natural attractions and a favorite spot for hikers and nature enthusiasts.",
        workTime: "Accessible depending on weather conditions",
        owner: {
            _id: "user7",
            username: "rila_admin",
            email: "admin@rilanature.bg"
        },
        createdAt: "2024-01-07T15:00:00Z",
        updatedAt: "2024-01-07T15:00:00Z",
        __v: 0
    },
    "8c9d0e1f-2g3h-4i5j-6k7l-m8n9o0p3q4r5":{
        name: "Old Nessebar",
        city: "Nessebar",
        image: "https://adventuresoflilnicki.com/wp-content/uploads/2024/02/Nessebar-Old-Town-Nessebar-Black-Sea-Bulgaria-2.jpg",
        description: "Old Nessebar is a UNESCO World Heritage Site featuring cobblestone streets, ancient ruins, and charming wooden houses. It is a historical and cultural gem on the Black Sea coast.",
        workTime: "Monday-Sunday: 09:00 - 20:00",
        owner: {
            _id: "user8",
            username: "nessebar_admin",
            email: "admin@oldnessebar.bg"
        },
